    ...
    info = {
        ...
        {"experimental_sst_hash_index_pin",
         {offsetof(struct BlockBasedTableOptions, experimental_sst_hash_index_pin),
          OptionType::kBoolean, OptionVerificationType::kNormal}},
        {"experimental_sst_seek_dir_enable",
         {offsetof(struct BlockBasedTableOptions, experimental_sst_seek_dir_enable),
          OptionType::kBoolean, OptionVerificationType::kNormal}},
        {"experimental_sst_seek_dir_pin",
         {offsetof(struct BlockBasedTableOptions, experimental_sst_seek_dir_pin),
          OptionType::kBoolean, OptionVerificationType::kNormal}},
        {"checksum",
