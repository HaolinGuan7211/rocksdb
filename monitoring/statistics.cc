...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {EXPERIMENTAL_KVSEP_BPTREE_MGET_KEYS_GROUPED,
     "rocksdb.experimental.kvsep_bptree.mget.keys.grouped"},
    {EXPERIMENTAL_KVSEP_BPTREE_MGET_LEAF_GROUPS,
     "rocksdb.experimental.kvsep_bptree.mget.leaf.groups"},
    {EXPERIMENTAL_KVSEP_BPTREE_MGET_LEAF_REUSE_KEYS,
     "rocksdb.experimental.kvsep_bptree.mget.leaf.reuse.keys"},
    {EXPERIMENTAL_KVSEP_BPTREE_MGET_LEAF_BLOCKS,
     "rocksdb.experimental.kvsep_bptree.mget.leaf.blocks"},
    {EXPERIMENTAL_KVSEP_BPTREE_MGET_VALUE_BLOCKS,
     "rocksdb.experimental.kvsep_bptree.mget.value.blocks"},
    {EXPERIMENTAL_KVSEP_BPTREE_MGET_FALLBACK_GET,
     "rocksdb.experimental.kvsep_bptree.mget.fallback.get"},
    {EXPERIMENTAL_KVSEP_BPTREE_LEAF_CACHE_HIT,
     "rocksdb.experimental.kvsep_bptree.leaf.cache.hit"},
    {EXPERIMENTAL_KVSEP_BPTREE_LEAF_CACHE_MISS,
     "rocksdb.experimental.kvsep_bptree.leaf.cache.miss"},
    {EXPERIMENTAL_KVSEP_BPTREE_LEAF_FILE_READS,
     "rocksdb.experimental.kvsep_bptree.leaf.file.reads"},
    {EXPERIMENTAL_KVSEP_BPTREE_LEAF_FILE_READ_BYTES,
     "rocksdb.experimental.kvsep_bptree.leaf.file.read.bytes"},
    {EXPERIMENTAL_KVSEP_BPTREE_VALUE_CACHE_HIT,
     "rocksdb.experimental.kvsep_bptree.value.cache.hit"},
    {EXPERIMENTAL_KVSEP_BPTREE_VALUE_CACHE_MISS,
     "rocksdb.experimental.kvsep_bptree.value.cache.miss"},
    {EXPERIMENTAL_KVSEP_BPTREE_VALUE_FILE_READS,
     "rocksdb.experimental.kvsep_bptree.value.file.reads"},
    {EXPERIMENTAL_KVSEP_BPTREE_VALUE_FILE_READ_BYTES,
     "rocksdb.experimental.kvsep_bptree.value.file.read.bytes"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_CACHE_HIT,
     "rocksdb.experimental.kvsep_bptree.pair.cache.hit"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_CACHE_MISS,
     "rocksdb.experimental.kvsep_bptree.pair.cache.miss"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_FILE_READS,
     "rocksdb.experimental.kvsep_bptree.pair.file.reads"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_FILE_READ_BYTES,
     "rocksdb.experimental.kvsep_bptree.pair.file.read.bytes"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_FILE_READS_SEEK,
     "rocksdb.experimental.kvsep_bptree.pair.file.reads.seek"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_FILE_READ_BYTES_SEEK,
     "rocksdb.experimental.kvsep_bptree.pair.file.read.bytes.seek"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_FILE_READS_SCAN,
     "rocksdb.experimental.kvsep_bptree.pair.file.reads.scan"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_FILE_READ_BYTES_SCAN,
     "rocksdb.experimental.kvsep_bptree.pair.file.read.bytes.scan"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_FILE_READS_MULTIGET,
     "rocksdb.experimental.kvsep_bptree.pair.file.reads.multiget"},
    {EXPERIMENTAL_KVSEP_BPTREE_PAIR_FILE_READ_BYTES_MULTIGET,
     "rocksdb.experimental.kvsep_bptree.pair.file.read.bytes.multiget"},
    {EXPERIMENTAL_SUPER_BLOCK_READ_CACHE_HIT,
     "rocksdb.experimental.super_block_read_cache.hit"},
    {EXPERIMENTAL_SUPER_BLOCK_READ_CACHE_MISS,
     "rocksdb.experimental.super_block_read_cache.miss"},
    {EXPERIMENTAL_SUPER_BLOCK_READ_UNUSABLE_TOO_LARGE,
     "rocksdb.experimental.super_block_read_cache.unusable.too_large"},
    {EXPERIMENTAL_SUPER_BLOCK_READ_UNUSABLE_CROSS_BOUNDARY,
     "rocksdb.experimental.super_block_read_cache.unusable.cross_boundary"},
