...
#define DEF_PERF_CONTEXT_METRICS(defCmd)           \
  ...
  defCmd(experimental_sst_seek_dir_seek_binary_steps) \
  defCmd(experimental_sst_seek_dir_seek_cmp_bytes) \
  defCmd(experimental_sst_seek_dir_seek_num_data_blocks_sum) \
